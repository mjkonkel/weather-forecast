...
// function that starts the API function when user clicks search button //
function handleUserinput() {
  var userInput = searchValueEl.value
  searchForCity(userInput)
}

// function that runs the geo API //
...
// function that runs the current weather API //
function currentWeather(lat, lon) {
  ...
  fetch(currentUrl)
    ...
    .then(function (data) {
      ...
      // set text content for current weather elements //
      ...
      // append current weather display //
...
// function that runs the forcast API //
...
// create button from cities saved in local storage //
function creatBtn() {
  savedList.innerHTML = ''
...
// create buttons on page load in the saved list //
function loadBtn() {
...
// run searchForCity function when user clicks a saved list button //
